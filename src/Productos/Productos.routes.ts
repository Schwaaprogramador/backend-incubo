...
productosRouter.post('/', verificarToken, verificarAdmin, uploadProducto.single('imagen'), (req, res) => productosController.crearProducto(req, res));
productosRouter.post('/:id/imagen', verificarToken, verificarAdmin, uploadProducto.single('imagen'), (req, res) => productosController.subirImagen(req, res));
